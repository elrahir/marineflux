...
function HeroSection({ locale }: { locale: string }) {
  ...
  return (
    <section className="relative py-20 md:py-32 lg:py-40 overflow-hidden bg-gradient-to-br from-maritime-50 via-ocean-50 to-white">
      {/* Decorative Background Elements */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-0 right-0 w-96 h-96 bg-maritime-200 rounded-full opacity-20 blur-3xl"></div>
        <div className="absolute bottom-0 left-0 w-96 h-96 bg-ocean-200 rounded-full opacity-20 blur-3xl"></div>
      </div>

      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="max-w-6xl mx-auto text-center">
          {/* Badge */}
          <div className="inline-flex items-center gap-2 bg-white border border-maritime-200 rounded-full px-6 py-2 mb-8 shadow-sm">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-12 max-w-6xl mx-auto">
          ...
          <div className="group relative">
            <div className="absolute inset-0 bg-gradient-to-br from-maritime-400 to-ocean-500 rounded-2xl opacity-0 group-hover:opacity-10 transition-opacity duration-300"></div>
            <Card className="relative border-2 border-gray-200 hover:border-maritime-400 transition-all duration-300 hover:shadow-2xl rounded-2xl overflow-hidden card-hover">
              <div className="absolute top-0 right-0 w-32 h-32 bg-maritime-100 rounded-full -mr-16 -mt-16 opacity-50"></div>
              <CardHeader className="space-y-4 p-8 relative">
                <div className="w-16 h-16 bg-maritime-100 rounded-xl flex items-center justify-center">
          ...
          {/* Supplier Portal */}
          <div className="group relative">
            <div className="absolute inset-0 bg-gradient-to-br from-green-400 to-emerald-500 rounded-2xl opacity-0 group-hover:opacity-10 transition-opacity duration-300"></div>
            <Card className="relative border-2 border-gray-200 hover:border-green-400 transition-all duration-300 hover:shadow-2xl rounded-2xl overflow-hidden card-hover">
              ...
              <CardContent className="p-8 pt-0">
                <Link href={`/${locale}/login?type=supplier`}>
                  <Button size="lg" className="w-full bg-green-600 hover:bg-green-700 text-white shadow-md">
