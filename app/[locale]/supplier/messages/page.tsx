...
export default function SupplierMessagesPage({ params }: { params: Promise<{ locale: string }> }) {
                      ...
                      return (
                        <div
                          ...
                          className={`p-4 border-b border-gray-100 cursor-pointer transition-colors hover:bg-gray-50 ${
                            isSelected ? 'bg-emerald-50 border-l-4 border-l-emerald-700' : ''
                          }`}
                        >
                          <div className="flex items-start gap-3">
                            ...
                            <div className="flex-1 min-w-0">
                              ...
                              <div className="flex items-center justify-between">
                                ...
                                {unreadCount > 0 && (
                                  <Badge className="ml-2 bg-emerald-700 text-white">
                                    {unreadCount}
                                  </Badge>
                                )}
                              </div>
